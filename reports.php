...
<?php elseif ($reportType === 'by_show'): ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
                <div class="mb-3">
                    <h4 class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#<?php echo $showId; ?>" aria-expanded="true" aria-controls="<?php echo $showId; ?>">
...
<?php elseif ($reportType === 'by_space'): ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
                <div class="mb-3">
                    <h4 class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#<?php echo $spaceId; ?>" aria-expanded="true" aria-controls="<?php echo $spaceId; ?>">
                        <i class="ti ti-chevron-down me-2 collapse-icon"></i>
