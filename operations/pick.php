        ...
        <?php else: ?>
            ...
            document.getElementById('completeBtn').addEventListener('click', () => {
                ...
                const confirmMsg = needsApproval 
                    ? 'Complete this pick? This will require admin approval before being finalized.' 
                    : 'Complete this pick? All items will be marked as checked out.';
                ...
                post('ajax=1&action=complete_pick', data => {
                    if (data.success) {
                        playSuccess();
                        if (needsApproval) {
                            alert('Pick completed! Pending admin approval.');
                        } else {
